        ...
        // ---------------------------end functions for System Logs---------------------------------------
            ...
            $(document).ready(function() 
            {
                ...
                $("#BtnBackToCons").click(function(){
                    ...
                    if (studID != '' && date != '' && time != ''){
                        window.location.href= "../../Consultation/pages/newConsultation.php?id=" +studID +"&date=" +date +"&time=" +time +"&type=backToCons";
                    }else{
                        $.alert({
                        theme: 'modern',
...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET'){
        if($_GET["type"] == "newFollowUp"){
            ...
            /*$sql = "SELECT * FROM followup WHERE IdNumb='$id' AND cons_date='$date' AND cons_time='$time'";
            $result = $connection->query($sql);
            $Row = $result->fetch_assoc();
