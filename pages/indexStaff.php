                                ...
                                <tr>
                                    ...
                                    echo "<td>";
                                        ...
                                        if(stripslashes($Row['AccessLevel']) == "superadmin" && $type == 'checkRecords'){
                                            ...
                                            <a class='viewBTN btn btn-danger btn-sm' id='archiveBTN' title='Restore' data-toggle='tooltip' data-placement='bottom' onclick='userRestoreRecord($Row[user_id])'><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' class='bi bi-arrow-counterclockwise' viewBox='0 0 16 16'>
