            ...
            function userRestoreRecord(StudentID){
                ...
                if(confirm("Are you sure you want to restore this Consultation Record?")){
                    ...
                    success:function(xml){
                        ...
                        window.location.href = 'index.php?type=checkArchivedConsultation';
            ...
            <div class="tabs">
                ...
                <div id="notif">
                    <?php if ($_GET["type"] == "checkRecords" || $type == 'checkRange' || $type == 'checkRecordsId' ){
                        echo "
                        <a id='newConsultation' class='btn btn-primary' href='pages/newConsultation.php?type=newCons' role='button'>New Consultation</a>
                                ...
                                if ($_GET["type"] == "checkRecords"){
                                    ...
                                    echo "<td>$row[cons_archive_reason]</td>";
                                        ...
                                        if ($type == 'checkRecordsId' || $type == 'checkRange'){
                                            echo "<td>
                                            <a class='viewBTN btn btn-primary btn-sm'  href='pages/newConsultation.php?num=$row[Num]&type=viewCons'>View</a>
                                            <a class='viewBTN btn btn-primary btn-sm'  href='../Followup/index.php?id=$row[IdNumb]&date=$row[Dates]&time=$row[Times]&type=checkRelFU'>Follow-ups</a>
                                            ...
                                            echo "<td>
                                            <a class='viewBTN btn btn-primary btn-sm' href='pages/newConsultation.php?num=$row[Num]&type=viewArchivedCons'>View</a>
