...
date_default_timezone_set('Asia/Manila');
  ...
  $XMLData .= ' StudentTerm = ' . '"'.$TxtStudentTerm.'"';
      ...
      if($ClinicRecordQuery)
      {
        ...
        if($Row)
          {        
            ...
            $TxtStatus = stripslashes($Row['Status']);;
            ...
            $TxtStudentTerm = stripslashes($Row['Term']);;
