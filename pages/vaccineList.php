            ...
            <div class="modal-content">
                ...
                <form action="#" method="post" id="vaccine-form" autocomplete="off">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="addVaccineBtn" type="Submit" class="btn btn-primary">Add Vaccine</button>
                    </div>
                </form>
            </div>
            </div>
                          ...
                          {  
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><button id="deleteVaccine" style="align-self: center;" class='viewBTN btn btn-primary btn-sm' onclick="deleteVaccine(<?php echo $Row['id']; ?>)" data-toggle='tooltip' data-placement='bottom' title='Delete'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
