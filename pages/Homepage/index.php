      ...
      <div class="chart-container col-md-4">
        ...
        <script> //Javascript for the echart
          ...
          function changeLink(){
            ...
            document.getElementById('linkPM').href="../Student/index.php?type=checkRange&start=" +startDateStr +"&end=" +endDateStr;
            document.getElementById('linkCons').href="../Consultation/index.php?type=checkRange&start=" +startDateStr +"&end=" +endDateStr;
            document.getElementById('linkFU').href="../Followup/index.php?type=checkRange&start=" +startDateStr +"&end=" +endDateStr;
            document.getElementById('linkMC').href="../MedicalCertificate/index.php?type=checkRange&start=" +startDateStr +"&end=" +endDateStr;
