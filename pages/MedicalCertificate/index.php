    ...
    <nav class="navbar navbar-expand navbar-light bg-light">
        ...
        <ul class="navbar-nav">
            ...
            <div class="dropdown-menu dropdown-menu-lg-right" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="index.php?type=checkMC">Medical Certificate</a>
            </div>
            </li>
            ...
            <div class="dropdown-menu dropdown-menu-lg-right" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="index.php?type=checkArchivedMC">Archived Medical Certificates</a>
            ...
            <div class="tabs">
                <div class="tabs-head" style="display: inline-block;">
                    <?php  
                        if ($_GET["type"] == "checkMCId"){
                            echo "
                            <div>
                            <a id='backButton' class='btn btn-primary' href='index.php?type=checkMC' role='button'>Go Back</a>
                            </div>";
                        }
                    ?>
                ...
                <div id="notif">
                    <?php if ($_GET["type"] == "checkMC" || $type == 'checkRange' || $type == 'checkMCId'){
                        echo "
                        <a id='newConsultation' class='btn btn-primary' href='page/medicalCertificate.php?type=newMC' role='button'>New Certificate</a>
                                ...
                                if ($_GET["type"] == "checkMC"){
                                    ...
                                    echo "<td>$row[mc_archive_reason]</td>";
                                        ...
                                        if ($type == 'checkMCId' || $type == 'checkRange'){
                                            echo "<td>
                                            <a class='viewBTN btn btn-primary btn-sm' href='page/medicalCertificate.php?studentID=$row[student_id]&id=$row[mc_id_num]&type=viewMC'>View</a>
                                            ...
                                            echo "<td>
                                            <a class='viewBTN btn btn-primary btn-sm' href='page/medicalCertificate.php?studentID=$row[student_id]&id=$row[mc_id_num]&type=viewArchivedMC'>View</a>
                                            ...
                                            echo "<td>
                                            <a class='viewBTN btn btn-primary btn-sm' href='index.php?type=checkMCId&id=$row[student_id]'>View All</a>
