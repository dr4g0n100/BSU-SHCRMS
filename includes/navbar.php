<nav class="navbar navbar-expand navbar-light bg-light">
    <li class="nav-item userFN">
      ...
      <ul class="navbar-nav">
        <li class="nav-item mx-1" id="navHome">
          <a class="nav-link" href="indexHomepage.php">Home</a>
        </li>
         <li class="nav-item dropdown mx-1" id="navCensus">
        ...
        <li class="nav-item mx-1" id="navUser">
          <a class="nav-link admin-nav" href="indexStaff.php?type=checkRecords">User List</a>
        </li>
        <li class="nav-item dropdown mx-1" id="navRecord">
        ...
        <li class="nav-item dropdown mx-1 admin-nav" id="navArchive">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-display="static" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Archived Records
          </a>
          <div class="dropdown-menu dropdown-menu-lg-right" aria-labelledby="navbarDropdown">
        ...
        <li class="nav-item dropdown mx-1 admin-nav" id="navMaintenance">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-display="static" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <li class="nav-item mx-1" id="navHelp">
