<?php 
$position = ucwords($_SESSION['homePosDisp']);
$staff_name = ucwords(strtolower($_SESSION['fullname']));
$staff_name = preg_replace_callback('/(?:^|\-)\K\w/', 
    function($m) {
...
<nav class="navbar navbar-expand navbar-light bg-light">
    <li class="nav-item userFN">
      <span id="userFullname"><b><?php echo "$position $staff_name" ;?></b></span>
    </li>
      <div class="mr-auto"></div>
      <ul class="navbar-nav">
        <li class="nav-item " id="navHome" data-toggle="tooltip" data-placement="left" title="Homepage">
          <a class="nav-link" href="indexHomepage.php">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-house-door" viewBox="0 0 16 16">
              <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146ZM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5Z"/>
            </svg>
          </a>
        </li>
         <li class="nav-item dropdown " id="navCensus" data-toggle="tooltip" data-placement="left" title="Census">
        ...
        <li class="nav-item admin-nav" id="navUser" data-toggle="tooltip" data-placement="left" title="User List">
        ...
        <li class="nav-item dropdown " id="navRecord" data-toggle="tooltip" data-placement="left" title="Records">
        ...
        <li class="nav-item dropdown  admin-nav" id="navArchive" data-toggle="tooltip" data-placement="left" title="Archives">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-display="static" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <li class="nav-item dropdown admin-nav" id="navMaintenance" data-toggle="tooltip" data-placement="left" title="Maintenance">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-display="static" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <li class="nav-item " data-toggle="tooltip" data-placement="left" title="User">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-display="static" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="dropdown-menu dropdown-menu-lg-right" aria-labelledby="navbarDropdown">
            <a class="dropdown-item text-center" href="help.php?type=<?php echo $_SESSION['accesslevel']; ?>" >Manual</a>
            <a class="dropdown-item text-center" href="../php/logout.php">
              Logout
            </a>
          </div>
        </li>
