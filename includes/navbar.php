...
<nav class="navbar navbar-expand navbar-light bg-light">
    <li class="nav-item userFN">
      ...
      <ul class="navbar-nav">
        <li class="nav-item " id="navHome" data-toggle="tooltip" data-placement="bottom" title="Homepage">
         ...
         <li class="nav-item dropdown " id="navCensus" data-toggle="tooltip" data-placement="bottom" title="Census">
        ...
        <li class="nav-item dropdown " id="navRecord" data-toggle="tooltip" data-placement="bottom" title="Records">
          ...
          <div class="dropdown-menu dropdown-menu-lg-right" data-toggle="tooltip" data-placement="bottom" aria-labelledby="navbarDropdown">
        ...
        <li class="nav-item dropdown  admin-nav" id="navArchive" data-toggle="tooltip" data-placement="bottom" title="Archives">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-display="static" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <li class="nav-item dropdown admin-nav" id="navMaintenance" data-toggle="tooltip" data-placement="bottom" title="Maintenance">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-display="static" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
