...
date_default_timezone_set('Asia/Manila');
  ...
  function FetchUser($num,$userid,$editdate){
    ...
    global $Error, $ClinicRecordsDB, $Message, $TxtStudentIDNumber,$TxtPhysician,$TxtPhysicianIDNumber,$TxtDate,$TxtTime,$TxtConsDate,$TxtConsTime,$TxtComplaints,$TxtDiagnosis,$TxtDiagnosticTest,$TxtMedicineGiven,$TxtTemperature,$TxtBP,$TxtPR,$TxtRemarks,$TxtPhysicalFindings,$TxtConsMSEditor;
      ...
      $sql = "SELECT * FROM history_followup  WHERE cons_editor = '$userid' AND cons_edited_at = '$editdate'";
