      ...
      if($ClinicRecordQuery)
      {
        ...
        if($Row)
          {        
			...
			$pdf->SetFont($font,'',$fontSize);
			$pdf->Cell(20,$fieldsSpacing+1,$PresentAddress[0],'T B',0,'L');
			$pdf->Cell(25,$fieldsSpacing+1,$PresentAddress[1],'T B',0,'L');
			$pdf->Cell(25,$fieldsSpacing+1,$PresentAddress[2],'T B',0,'L');
			$pdf->Cell(25,$fieldsSpacing+1,$PresentAddress[3],'T B',0,'L');
			$pdf->Cell(33,$fieldsSpacing+1,$PresentAddress[4],'T B R',0,'C');
			$pdf->Ln($fieldsSpacing+1);
			$pdf->Cell(25,$fieldsSpacing,'',0,0,'C');
			$pdf->SetFont($font,'I',$fontSize-2);
			$pdf->Cell(20,$fieldsSpacing,'(House No.)','T B',0,'L');
			$pdf->Cell(25,$fieldsSpacing,'(Street)','T B',0,'L');
			$pdf->Cell(25,$fieldsSpacing,'(Barangay)','T B',0,'L');
			$pdf->Cell(25,$fieldsSpacing,'(Municipality)','T B',0,'L');
			$pdf->Cell(33,$fieldsSpacing,'(Province)','T B R',0,'C');
			$pdf->Ln($fieldsSpacing);
