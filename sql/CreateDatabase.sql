...
CREATE TABLE db_degree_list (
  ...
  degree_acr varchar(255) NOT NULL,
...
CREATE TABLE PersonalMedicalRecord (
  id_num bigint(20) unsigned ZEROFILL auto_increment,
  ...
  Address varchar(255),
  ProvAdd varchar(255),
  StudentContactNumber varchar(255),
  GuardianParent enum('guardian','parent','none'),
  GPCategory varchar(255),
  ContactPerson varchar(255),
  PGContactNumber varchar(255),
  GuardianParent1 enum('guardian','parent','none'),
  GPCategory1 varchar(255),
  ContactPerson1 varchar(255),
  PGContactNumber1 varchar(255),
  GuardianParent2 enum('guardian','parent','none'),
  GPCategory2 varchar(255),
  ContactPerson2 varchar(255),
  PGContactNumber2 varchar(255),
...
CREATE TABLE MEDICALCERTIFICATE (
  /*Num bigint(20) unsigned ZEROFILL auto_increment,*/
  mc_id_num bigint(20) NOT NULL auto_increment,
...
CREATE TABLE USERACCOUNTS (
  user_id bigint(20) unsigned ZEROFILL auto_increment,
  ...
  LoginChance bigint(20) NOT NULL default 3,
  code bigint(20),
  created_at varchar(255),
  updated_at varchar(255),
  archived_at varchar(255),
...
CREATE TABLE SYSTEMLOGS (
  IdNum bigint(20) unsigned ZEROFILL auto_increment,
...
CREATE TABLE ARCHIVEDSTUDENT (
  ...
  PGContactNumber varchar(255) NOT NULL,
  GuardianParent1 enum('guardian','parent','none'),
  GPCategory1 varchar(255),
  ContactPerson1 varchar(255),
  PGContactNumber1 varchar(255),
